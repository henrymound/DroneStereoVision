...
NO_SHRINK = False # When true, doesn't allow batches to shrink in size as more images are added
...
STITCH_HEIGHT_MIN_RATIO = 2.6

NUM_IMAGES = 51
START_NUM = 0
BATCH_BOUND = 51 # The maximum images allowed in a batch
BATCH_MIN = 1 # The minimum number of photos to fill a batch
